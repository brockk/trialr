...
namespace model_EightSchools_namespace {
...
class model_EightSchools : public prob_grad {
private:
    int J;
    vector<double> y;
    vector<double> sigma;
public:
    model_EightSchools(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        typedef boost::ecuyer1988 rng_t;
        rng_t base_rng(0);  // 0 seed default
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_EightSchools_namespace::model_EightSchools";
        (void) function__; // dummy call to supress warning
        size_t pos__;
        (void) pos__; // dummy call to supress warning
        std::vector<int> vals_i__;
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<double> in__(params_r__,params_i__);
        static const char* function__ = "model_EightSchools_namespace::write_array";
        (void) function__; // dummy call to supress warning
        // read-transform, write parameters
...
namespace model_ThallHierachicalBinary_namespace {
...
class model_ThallHierachicalBinary : public prob_grad {
private:
    int m;
    vector<int> x;
    vector<int> n;
    ...
    double tau_beta;
public:
    model_ThallHierachicalBinary(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        typedef boost::ecuyer1988 rng_t;
        rng_t base_rng(0);  // 0 seed default
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ThallHierachicalBinary_namespace::model_ThallHierachicalBinary";
        (void) function__; // dummy call to supress warning
        size_t pos__;
        (void) pos__; // dummy call to supress warning
        std::vector<int> vals_i__;
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<double> in__(params_r__,params_i__);
        static const char* function__ = "model_ThallHierachicalBinary_namespace::write_array";
        (void) function__; // dummy call to supress warning
        // read-transform, write parameters
        double mu = in__.scalar_constrain();
    ...
    static std::string model_name() {
        return "model_ThallHierachicalBinary";
    }
