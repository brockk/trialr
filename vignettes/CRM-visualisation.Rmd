...
If you are a fan of post-punk UK music (and you have installed the [`ggridges`](https://cran.r-project.org/web/packages/ggridges/) package), you may however prefer to show this information using a ridge plot, aka a [joyplot](https://en.wikipedia.org/wiki/Unknown_Pleasures)
