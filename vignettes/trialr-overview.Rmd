...
Let us assume that we have already treated 2 patients each at doses 2, 3 and 4, havig only seen toxicity at dose-level 4.
...
mod1 <- stan_crm(outcome_str = '2NN 3NN 4TT', skeleton = skeleton, 
                 target = target, beta_sd = sqrt(1.34), seed = 123)
```
