...
Let us assume that we have already treated 6 patients at 3 doses:
...
What dose should we give to the 7th patient?
...
We can extract the posterior etimates of the probability of toxicity at each dose and perform inference as the Bayesian method would suggest:
