...
```{r, fig.width = 6, fig.height = 6, fig.cap = "Posterior Prob(Efficacy) in the six PePS2 cohorts", eval=FALSE}
...
In ```peps2_run_sims```, the second and third args are delegates to simulate trial outcomes and post-process the ```rstan``` sample respectively.
